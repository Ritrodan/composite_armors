...
const set=renderSet({...D,wedge:true,tilesX:1,tilesY:3,material:'nera'});
for(const k of ['armor.png','external_walls.png','blueprints.png','roof.png','external_wall_normals.png']) writeFileSync('/tmp/o13_'+k,Buffer.from(encodePNG(set[k])));
